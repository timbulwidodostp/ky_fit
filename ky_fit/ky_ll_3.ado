** MLE for mismatch in Admin data and no classic contamination just regression to mean
/*
ri
r1=e_i
r2=t_i
...
program define ky_ll_3
version 15

** all variables that require estimation
args lnf mu_e mu_n mu_t  ln_sig_e ln_sig_n ln_sig_t arho_s lpi_r  lpi_s
qui {
	** Program interesting 
	...
	** all densities
	...
	replace `lnf'=log(`pi_2'*exp(`lnf2')+`pi_3'*exp(`lnf3')+`pi_4'*exp(`lnf4')) if $ML_y3==0
    }
end
